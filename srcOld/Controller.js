...
export default class Controller {
	...
	constructor(dh) {
		...
		this._stopKeys = {};
		this._watchList = [];
		this._runnerManager = new RunnerManager(this);
	...
	// publicMethod
	hasRunner = (name) => {
		return this._runnerManager.hasRunner(name);
	}
	
	// publicMethod
	cancel = (name) {
		return this._runnerManager.cancel(name);
	}
	
	// publicMethod
	register = (name, callback) => {
		return this._runnerManager.register(name, callback);
	}
	
	// publicMethod
	run = (name, ...args) => {
		return this._runnerManager.run(name, ...args);
	}
