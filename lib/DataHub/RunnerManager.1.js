...
function () {
  function RunnerManager(dhc) {
    ...
    this._emitter.once("$$destroy:".concat(dhc._clazz, ":").concat(dhc._key), function () {
      _this.devLog && _this.devLog("".concat(dhc._clazz, " destroyed => ").concat(_this._clazz, " destroy ."));
