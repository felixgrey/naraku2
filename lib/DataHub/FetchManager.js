...
var FetchManager = (_class = class FetchManager extends _Component.default {
  ...
  fetchStoreData() {
    ...
    this.fetchingDatastore[name] = setTimeout(() => {
      ...
      var pagination = ds.paginationManager;
      var {
        fetcher = null
      } = ds.getStoreConfig();
      ...
      var pageInfo = pagination.getPageInfo();
      ...
      data[pageInfo.pageSizeField] = pagination.size; // fetcher, data = null, dataInfo = {}, stopKey = null
