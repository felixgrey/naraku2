...
var eventOpMethods = ['when', 'whenAll', 'on', 'once', 'emit', 'clear', 'destroy'];
...
function () {
  ...
  _createClass(Controller, [{
    ...
    value: function emit(name) {
      ...
      return this._emitter.apply(this, [name].concat(args));
    }
  }, {
    key: "clear",
    value: function clear(name) {
      if (this._destroyed) {
        this.errLog("can't run 'clear' event='".concat(name, "' after controller=").concat(this._key, " destroy."));
