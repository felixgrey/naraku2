...
function () {
  function Controller(dh) {
    ...
    this._fetchManager = new _FetchManager.default(this, _devMode); // ListenerManager
...
Controller.publicMethods = publicMethods.concat(_DataStore.default.publicMethods).concat(_ListenerManager.default.publicMethods);