...
var _ListenerManager = _interopRequireDefault(require("./ListenerManager"));
...
var publicMethods = ['createController', 'watch'];
var refreshRate = 40;
  ...
  function Controller(dh) {
    ...
    this._publicMethods = {
      ...
      isLoading: function isLoading() {
        return _this.isLoading.apply(_this, arguments);
      },
      isLocked: function isLocked() {
        return _this.isLocked.apply(_this, arguments);
      }
    };
    this._dh = dh;
    ...
    this._fetchManager = new _FetchManager.default(this, refreshRate, _devMode); // ListenerManager

    this.devLog("Controller=".concat(this._key, " created."));
  }
...
Controller.publicMethods = publicMethods.concat(_DataStore.default.publicMethods).concat(_ListenerManager.default.publicMethods).concat(_FetchManager.default.publicMethods);