...
function () {
  function Emitter() {
    ...
    this.devLog = _devMode ? devLog.createLog("Emitter=".concat(this._key)) : _Utils.udFun;
    this.errLog = errLog.createLog("Emitter=".concat(this._key));
    this.destroyedErrorLog = (0, _Utils.createDestroyedErrorLog)('Emitter', this._key);
    this.devLog("Emitter=".concat(this._key, " created."));
  }
