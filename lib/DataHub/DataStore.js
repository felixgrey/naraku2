...
function () {
  function DataStore(dh, name) {
    ...
    this._value = [];
    this._storeConfig = {};
    this._pagination = new _PaginationManager.default(dh, name, _devMode);
    this._oldStatus = 'undefined';
    this._status = 'undefined';
    this._lockStack = 0;
    this._errMsg = null;

    dh._emitter.once("$$destroy:DataHub:".concat(dh._key), function () {
      _this.devLog && _this.devLog("DataHub destroyed .");
  ...
  _createClass(DataStore, [{
    ...
    value: function setConfig() {
      ...
      var _cfg$pagination = cfg.pagination,
          pagination = _cfg$pagination === void 0 ? null : _cfg$pagination;
