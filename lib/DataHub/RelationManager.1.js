...
/*#__PURE__*/
function () {
  function RelationManager(store) {
    var _this = this;
    ...
    this.devLog = _devMode ? store.devLog.createLog(this._logName) : _Utils.udFun;
    this.errLog = store.errLog.createLog(this._logName);
    this.destroyedErrorLog = (0, _Utils.createDestroyedErrorLog)(this._clazz, this._key);

    this._emitter.once("$$destroy:".concat(store._clazz, ":").concat(store._key), function () {
