...
exports.NumberFormat = exports.createDestroyedErrorLog = exports.errorLog = exports.createLog = exports.uidSeed = exports.onGlobal = exports.showLog = exports.isDev = void 0;
...
var createDestroyedErrorLog = function createDestroyedErrorLog(clazz, key) {
  return function (funName) {
    ...
    dstroyedErrorLog("can't run \u3010".concat(clazz, "=").concat(key, "\u3011=>\u3010").concat(funName, "@[").concat(args.join(','), "]\u3011 after it is destroyed."));
  };
};
/*
	根据路径获取对象值
